...
const MotorheadzWindow = ({ theme }: Props) => {
  ...
  const readBlogPostButton = (
    <Button themeName='dark' icon={<ExternalLinkIcon height={16} />} href='https://mirror.xyz/0x57D1eAE9f0972723F0e78EAF4e6C08e90565206F/AtKMzoVY1qzrvA1gal1XqJv74bpx-sg9ptv5TDw2maU'>
      read blog post
    </Button>
  );
  ...
  const currentContentMetadata: ContentPaneMetadataType = {
    ...
    buttons: [viewOnOpenseaButton(`https://opensea.io/assets/optimism/${motorheadzContractAddress}/${currentImageIndex}`)]
  };
