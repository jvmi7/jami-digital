...
const Widget = ({ children, className, label, index, onClick }: { children: React.ReactNode; className?: string; label: string; index: number; onClick: () => void }) => {
  ...
  return (
    <motion.div onClick={onClick} variants={variants} initial='hidden' animate={'visible'} className={styles.widgetContainer}>
