          ...
          <div className={styles.headerButtons} style={{ backgroundColor: theme.windowAccent }}>
            <button
              ...
              style={{
                ...
                border: `2px solid ${theme.closeButtonBorder}`,
            ...
            <button onClick={handleResizeClicked} style={secondaryButtonStyles}>
              <span className={styles.icon}>
                {windowSizeState === 'full' ? (
                  <MinusIcon width={14} color={secondaryButtonStyles.color} />
                ) : (
                  <PlusIcon width={14} color={secondaryButtonStyles.color} />
                )}
              </span>
            </button>
          </div>
