...
function AboutScreen() {
  return (
    <div className={styles.container}>
      ...
      <Image className={styles.backgroundImage} src={`/clouds.png`} alt='background' width={500} height={500} draggable='false' />
    </div>
  );
}
